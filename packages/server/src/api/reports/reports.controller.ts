...
// version: 1.1.0 (FEAT: Add handler for product consumption detail)

import type { Response, NextFunction } from 'express';
import type { AuthRequest } from '../../middleware/auth.middleware.js';
import { generateConsumptionReport, getConsumptionDetailsForProduct } from './reports.service.js';
...
export const getProductConsumptionDetailHandler = async (
    ...
    try {
        ...
        // Validamos que todos los parámetros necesarios estén presentes
