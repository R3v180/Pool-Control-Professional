...
import { startOfWeek, addDays, getISOWeek, isWithinInterval, startOfDay, } from 'date-fns';
 ...
 */
async function generateWeeklyVisits(targetDate) {
    ...
    for (const template of templates) {
        ...
        const activeSeason = template.seasons.find(season => isWithinInterval(startOfTargetWeek, { start: season.startDate, end: season.endDate }));
        if (!activeSeason) {
