 ...
 */
export const createRouteTemplate = async (data) => {
 ...
 */
export const getRouteTemplatesByTenant = async (tenantId) => {
 ...
 */
export const getRouteTemplateById = async (id, tenantId) => {
 ...
 */
export const updateRouteTemplate = async (id, tenantId, data) => {
 ...
 * @param tenantId - El ID del tenant para validación.
 */
export const deleteRouteTemplate = async (id, tenantId) => {
