 ...
 */
export const getProductCategoriesByTenant = async (tenantId) => {
 ...
 */
export const updateProductCategory = async (id, tenantId, data) => {
 ...
 * @param tenantId - El ID del tenant del usuario que realiza la acción.
 */
export const deleteProductCategory = async (id, tenantId) => {
