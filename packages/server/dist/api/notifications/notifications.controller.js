...
import { getNotificationsForUser, markNotificationAsRead, resolveNotification, getNotificationHistory, classifyNotification, getNotificationById, // <-- Importar la nueva función
 ...
 */
export const getNotificationByIdHandler = async (req, res, next) => {
    try {
 ...
 */
export const resolveNotificationHandler = async (req, res, next) => {
    try {
        const userId = req.user?.id;
        const { notificationId } = req.params;
 ...
 */
export const classifyNotificationHandler = async (req, res, next) => {
    try {
        const userId = req.user?.id;
        const { notificationId } = req.params;
