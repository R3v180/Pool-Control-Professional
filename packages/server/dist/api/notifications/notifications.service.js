 ...
 */
export const getNotificationHistory = async (tenantId, page, pageSize, status, clientId) => {
 ...
 */
export const resolveNotification = async (notificationId, userId, resolutionNotes) => {
 ...
 */
export const classifyNotification = async (notificationId, userId, priority, deadline) => {
    return prisma.notification.update({
        where: { id: notificationId, userId: userId },
